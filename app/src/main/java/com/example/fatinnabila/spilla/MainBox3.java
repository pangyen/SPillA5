...
public class MainBox3 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private String mId;
    private DatabaseReference box3Reference, test;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.drawer_box3);
        this.context = this;
        boxs1 = new ArrayList<>();
        ...
        final Intent myIntent = new Intent(this.context, AlarmReceiver3.class);
        alarmManager3 = (AlarmManager) getSystemService(ALARM_SERVICE);// Get the alarm manager service
        mFirebaseAuth = FirebaseAuth.getInstance();
        mCurrentUser = mFirebaseAuth.getCurrentUser();
        test = FirebaseDatabase.getInstance().getReference(mCurrentUser.getUid()).child(Reference.TIME3);
        demoRef = FirebaseDatabase.getInstance().getReference(mCurrentUser.getUid()).child(Reference.DB_MESSAGE);
        box3Reference = FirebaseDatabase.getInstance().getReference(mCurrentUser.getUid()).child(Reference.DB_BOX3);
        ...
        pillsRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> pillsAdapter = new ArrayAdapter<String>(MainBox3.this, android.R.layout.simple_spinner_dropdown_item, pills);
        ...
        alarmTimePicker.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                new TimePickerDialog(MainBox3.this,
        ...
        start_alarm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (calendar.after(Calendar.getInstance())) {
                    ...
                    pending_intent1 = PendingIntent.getBroadcast(MainBox3.this, 0, myIntent, PendingIntent.FLAG_UPDATE_CURRENT);

//                   alarmManager.setRepeating(AlarmManager.RTC_WAKEUP, alarm_time,
//                   alarmManager.INTERVAL_DAY * 7, pending_intent);
                    alarmManager3.set(AlarmManager.RTC_WAKEUP, calendar.getTimeInMillis(), pending_intent1);
                }
...
//                Log.e("random number is ", String.valueOf(random_number));
    ...
    public void onStart() {
        ...
        box3Reference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                // clear table
                boxs1.clear();
...
//         the NotificationChannel class is new and not in the support library
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.nav_home:
                Intent h = new Intent(MainBox3.this, MainActivity.class);
                startActivity(h);
                break;
            case R.id.nav_pills:
                Intent i = new Intent(MainBox3.this, MainPills.class);
                startActivity(i);
                break;
            case R.id.nav_appointment:
                Intent g = new Intent(MainBox3.this, MainAppointment.class);
                startActivity(g);
                break;
            case R.id.nav_history:
                Intent s = new Intent(MainBox3.this, MainHistory.class);
                startActivity(s);
                break;
            case R.id.nav_guardian:
                Intent t = new Intent(MainBox3.this, MainGuardian.class);
                startActivity(t);
                break;
            case R.id.nav_mail:
                Intent v= new Intent(MainBox3.this,Profile.class);
                startActivity(v);
                break;
        }

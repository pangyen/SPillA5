...
public class MainBox4 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.drawer_box4);
        this.context = this;
        boxs1 = new ArrayList<>();
        ...
        final Intent myIntent = new Intent(this.context, AlarmReceiver4.class);
        alarmManager2 = (AlarmManager) getSystemService(ALARM_SERVICE);// Get the alarm manager service
        mFirebaseAuth = FirebaseAuth.getInstance();
        mCurrentUser = mFirebaseAuth.getCurrentUser();
        test = FirebaseDatabase.getInstance().getReference(mCurrentUser.getUid()).child(Reference.TIME4);
        demoRef = FirebaseDatabase.getInstance().getReference(mCurrentUser.getUid()).child(Reference.DB_MESSAGE);
        box1Reference = FirebaseDatabase.getInstance().getReference(mCurrentUser.getUid()).child(Reference.DB_BOX4);
        ...
        pillsRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> pillsAdapter = new ArrayAdapter<String>(MainBox4.this, android.R.layout.simple_spinner_dropdown_item, pills);
        ...
        alarmTimePicker.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                new TimePickerDialog(MainBox4.this,
        ...
        start_alarm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (calendar.after(Calendar.getInstance())) {
                    ...
                    pending_intent1 = PendingIntent.getBroadcast(MainBox4.this, 0, myIntent, PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    public void onStart() {
        ...
        box1Reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                //creating adapter
                Box1Adapter box1Adapter = new Box1Adapter(MainBox4.this, boxs1);
...
//         the NotificationChannel class is new and not in the support library
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.nav_home:
                Intent h = new Intent(MainBox4.this, MainActivity.class);
                startActivity(h);
                break;
            case R.id.nav_pills:
                Intent i = new Intent(MainBox4.this, MainPills.class);
                startActivity(i);
                break;
            case R.id.nav_appointment:
                Intent g = new Intent(MainBox4.this, MainAppointment.class);
                startActivity(g);
                break;
            case R.id.nav_history:
                Intent s = new Intent(MainBox4.this, MainHistory.class);
                startActivity(s);
                break;
            case R.id.nav_guardian:
                Intent t = new Intent(MainBox4.this, MainGuardian.class);
                startActivity(t);
                break;
            case R.id.nav_mail:
                Intent v= new Intent(MainBox4.this,Profile.class);
                startActivity(v);
                break;
        }

...
public class RingtonePlayingService4 extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId)
    {
        ...
        Intent intent1 = new Intent(this.getApplicationContext(), MainBox4.class);
    ...
    public void createNotification1() {
        ...
        Intent notification_intent = new Intent(this,RingtonePlayingService4.class);

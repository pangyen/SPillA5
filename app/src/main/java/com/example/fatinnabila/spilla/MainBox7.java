...
public class MainBox7 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Intent myIntent = new Intent(this.context, AlarmReceiver7.class);
        alarmManager1 = (AlarmManager) getSystemService(ALARM_SERVICE);// Get the alarm manager service
        mFirebaseAuth = FirebaseAuth.getInstance();
        mCurrentUser = mFirebaseAuth.getCurrentUser();
        test = FirebaseDatabase.getInstance().getReference(mCurrentUser.getUid()).child(Reference.TIME7);
        demoRef = FirebaseDatabase.getInstance().getReference(mCurrentUser.getUid()).child(Reference.DB_MESSAGE);
        box1Reference = FirebaseDatabase.getInstance().getReference(mCurrentUser.getUid()).child(Reference.DB_BOX7);
        ...
        pillsRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> pillsAdapter = new ArrayAdapter<String>(MainBox7.this, android.R.layout.simple_spinner_dropdown_item, pills);
        ...
        alarmTimePicker.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                new TimePickerDialog(MainBox7.this,
        ...
        start_alarm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (calendar.after(Calendar.getInstance())) {
                    ...
                    pending_intent1 = PendingIntent.getBroadcast(MainBox7.this, 0, myIntent, PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    public void onStart() {
        ...
        box1Reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                //creating adapter
                Box1Adapter box1Adapter = new Box1Adapter(MainBox7.this, boxs1);
...
//         the NotificationChannel class is new and not in the support library
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.nav_home:
                Intent h = new Intent(MainBox7.this, MainActivity.class);
                startActivity(h);
                break;
            case R.id.nav_pills:
                Intent i = new Intent(MainBox7.this, MainPills.class);
                startActivity(i);
                break;
            case R.id.nav_appointment:
                Intent g = new Intent(MainBox7.this, MainAppointment.class);
                startActivity(g);
                break;
            case R.id.nav_history:
                Intent s = new Intent(MainBox7.this, MainHistory.class);
                startActivity(s);
                break;
            case R.id.nav_guardian:
                Intent t = new Intent(MainBox7.this, MainGuardian.class);
                startActivity(t);
                break;
            case R.id.nav_mail:
                Intent v= new Intent(MainBox7.this,Profile.class);
                startActivity(v);
                break;
        }

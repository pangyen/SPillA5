...
public class HealthHistory extends AppCompatActivity
        ...
        mHistoryReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot noteSnapshot : dataSnapshot.getChildren()) {
                    HistoryModel model = noteSnapshot.getValue(HistoryModel.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.nav_home:
                Intent h= new Intent(HealthHistory.this,MainActivity.class);
                startActivity(h);
                break;
            case R.id.nav_pills:
                Intent i= new Intent(HealthHistory.this,Pills.class);
                startActivity(i);
                break;
            case R.id.nav_appointment:
                Intent g= new Intent(HealthHistory.this,Appointment.class);
                startActivity(g);
                break;
            case R.id.nav_history:
                Intent s= new Intent(HealthHistory.this,HealthHistory.class);
                startActivity(s);
                break;
            case R.id.nav_guardian:
                Intent t= new Intent(HealthHistory.this,Guardian.class);
                startActivity(t);
                break;

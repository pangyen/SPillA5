...
public class MainBox2 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private String mId;
    private DatabaseReference box2Reference, mFirebaseb2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Intent myIntent = new Intent(this.context, AlarmReceiver2.class);
        alarmManager2 = (AlarmManager) getSystemService(ALARM_SERVICE);// Get the alarm manager service
        mFirebaseAuth = FirebaseAuth.getInstance();
        mCurrentUser = mFirebaseAuth.getCurrentUser();
        mFirebaseb2 = FirebaseDatabase.getInstance().getReference(mCurrentUser.getUid()).child(Reference.TIME2);
        demoRef = FirebaseDatabase.getInstance().getReference(mCurrentUser.getUid()).child(Reference.DB_MESSAGE);
        box2Reference = FirebaseDatabase.getInstance().getReference(mCurrentUser.getUid()).child(Reference.DB_BOX2);
        ...
        pillsRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> pillsAdapter = new ArrayAdapter<String>(MainBox2.this, android.R.layout.simple_spinner_dropdown_item, pills);
        ...
        //displau time
        mFirebaseb2.child("time").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
        ...
        mFirebaseb2.child("status").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                String viewtime = dataSnapshot.getValue(String.class);
        ...
        alarmTimePicker.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                new TimePickerDialog(MainBox2.this,
        ...
        start_alarm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mFirebaseb2.child("time").setValue(alarmTimePicker.getText().toString());
                mFirebaseb2.child("status").setValue(alarmTextView.getText().toString());
                ...
                if (calendar.after(Calendar.getInstance())) {
                  ...
                  //  myIntent.putExtra("2","yes");
                    pending_intent1 = PendingIntent.getBroadcast(MainBox2.this, 0, myIntent, PendingIntent.FLAG_UPDATE_CURRENT);

//                   alarmManager.setRepeating(AlarmManager.RTC_WAKEUP, alarm_time,
//                   alarmManager.INTERVAL_DAY * 7, pending_intent);
                   // alarmManager2.set(AlarmManager.RTC_WAKEUP, calendar.getTimeInMillis(), pending_intent1);
                    alarmManager2.setRepeating(AlarmManager.RTC_WAKEUP, calendar.getTimeInMillis(), alarmManager2.INTERVAL_DAY*7,pending_intent1);
                }
        ...
        stop_alarm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mFirebaseb2.child("status").setValue("Alarm Cancelled");
...
//                Log.e("random number is ", String.valueOf(random_number));
                ...
                alarmManager2.cancel(pending_intent1);
    ...
    public void onStart() {
        ...
        box2Reference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                // clear table
                boxs1.clear();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.nav_home:
                Intent h = new Intent(MainBox2.this, MainActivity.class);
                startActivity(h);
                break;
            case R.id.nav_pills:
                Intent i = new Intent(MainBox2.this, MainPills.class);
                startActivity(i);
                break;
            case R.id.nav_appointment:
                Intent g = new Intent(MainBox2.this, MainAppointment.class);
                startActivity(g);
                break;
            case R.id.nav_history:
                Intent s = new Intent(MainBox2.this, MainHistory.class);
                startActivity(s);
                break;
            case R.id.nav_guardian:
                Intent t = new Intent(MainBox2.this, MainGuardian.class);
                startActivity(t);
                break;
            case R.id.nav_mail:
                Intent v= new Intent(MainBox2.this,Profile.class);
                startActivity(v);
                break;
        }
